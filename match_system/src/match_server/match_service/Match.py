...
class Client(Iface):
    ...
    def add_player(self, score, uuid, username, hero, channel_name):
        ...
        """
        self.send_add_player(score, uuid, username, hero, channel_name)
        return self.recv_add_player()

    def send_add_player(self, score, uuid, username, hero, channel_name):
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.score, args.uuid, args.username, args.hero, args.channel_name)
...
class add_player_args(object):
    ...
    def __init__(self, score=None, uuid=None, username=None, hero=None, channel_name=None,):
        self.score = score
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if self.hero is not None:
            oprot.writeFieldBegin('hero', TType.I32, 4)
            oprot.writeI32(self.hero)
            oprot.writeFieldEnd()
